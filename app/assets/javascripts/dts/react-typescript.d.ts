...
declare module 'react-typescript' {
    class ReactComponentBase<P, S> {
         ...
         * completed.
         *
         * @param {object} nextProps Next partial state to be merged with state.
    ...
    class ReactComponentViewBase<P, S> extends ReactComponentBase<P,S> implements ReactComponent<P, S>{
        render:()=>any;
    }


    function toReactViewComponent<A, C extends ReactComponentViewBase<any, any>>(
        createReactComponent: {
            new(): C ;
        },
        view:any
