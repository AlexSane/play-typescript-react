...
//simply add
    ...
    exports.ReactComponentViewBase = ReactComponentBase;

    function toReactComponent(componentClass){
        return toReactComponentInt(componentClass, []);
    }

    function toReactViewComponent(componentClass, view){
        return toReactComponentInt(componentClass, [view]);
    }


    function toReactComponentInt(componentClass, mixins) {
        ...
        var spec = protoChain.reduce(function (spec, proto) {
            Object.keys(proto).reduce(function (spec, key) {
                if (key == 'constructor') return spec;
        ...
        //redefine properties with accessor on the prototype of the obtained component
    ...
    exports.toReactViewComponent = toReactViewComponent;
